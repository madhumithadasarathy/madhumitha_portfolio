...
export default function Projects() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white font-poppins relative overflow-hidden flex flex-col">
      ...
      <div 
        className={`transition-opacity duration-1000 ease-in-out flex-1 ${
          introComplete ? 'opacity-100' : 'opacity-0 h-0 overflow-hidden'
        }`}
      >
        <div className="pt-32 pb-20 px-6 relative h-full">
